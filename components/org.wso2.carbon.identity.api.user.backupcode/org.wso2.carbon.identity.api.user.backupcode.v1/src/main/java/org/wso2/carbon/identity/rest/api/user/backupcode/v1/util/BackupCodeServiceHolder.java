...
package org.wso2.carbon.identity.rest.api.user.backupcode.v1.util;

import org.wso2.carbon.context.PrivilegedCarbonContext;
import org.wso2.carbon.user.core.service.RealmService;

/**
 * Service holder class for backup code REST API.
 */
public class BackupCodeServiceHolder {

    private BackupCodeServiceHolder() {
