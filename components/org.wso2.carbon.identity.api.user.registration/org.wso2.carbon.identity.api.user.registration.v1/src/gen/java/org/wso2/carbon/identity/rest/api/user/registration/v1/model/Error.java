...
/**
 * Contains the data related to an error.
 **/
...
@ApiModel(description = "Contains the data related to an error.")
public class Error  {
    ...
    **/
    ...
    @ApiModelProperty(example = "ABA-00000", required = true, value = "")
    @JsonProperty("code")
    @Valid
    ...
    **/
    ...
    @ApiModelProperty(example = "e0fbcfeb-3617-43c4-8dd0-7b7d38e13047", required = true, value = "")
